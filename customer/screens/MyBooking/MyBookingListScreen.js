      ...
      switch (item.bookingStatus) {
          ...
          return (
            <View>
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.statusTextOk}>Menunggu Konfirmasi</Text>
              </View>
              <View style={{ flexDirection: 'row' }}>
        ...
        case 'Ticketing':
          return <View style={{ flexDirection: 'row' }}>
            <Text style={styles.activityDesc}>Status: </Text>
            <Text style={styles.statusOk}>Tiket Sedang Diproses</Text>
          </View>;
        case 'Ticketed':
          return (
            <View>
              <View style={{ flexDirection: 'row' }}>
                <Text style={styles.activityDesc}>Status: </Text>
                <Text style={styles.statusTextOk}>Dibatalkan</Text>
              </View>
              <View>
                <Button
